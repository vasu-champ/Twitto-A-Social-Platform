...
public class Follower extends org.jooq.impl.TableImpl<tech.codingclub.helix.tables.records.FollowerRecord> {
	...
	private static final long serialVersionUID = -541013048;
	...
	public java.util.List<org.jooq.UniqueKey<tech.codingclub.helix.tables.records.FollowerRecord>> getKeys() {
		return java.util.Arrays.<org.jooq.UniqueKey<tech.codingclub.helix.tables.records.FollowerRecord>>asList(tech.codingclub.helix.Keys.FOLLOWR_USER_ID_FOLLOWING_ID_KEY);
	}
	...
	public java.util.List<org.jooq.ForeignKey<tech.codingclub.helix.tables.records.FollowerRecord, ?>> getReferences() {
		return java.util.Arrays.<org.jooq.ForeignKey<tech.codingclub.helix.tables.records.FollowerRecord, ?>>asList(tech.codingclub.helix.Keys.FOLLOWER__FOLLOWR_USER_ID_FKEY, tech.codingclub.helix.Keys.FOLLOWER__FOLLOWR_FOLLOWING_ID_FKEY);
	}
